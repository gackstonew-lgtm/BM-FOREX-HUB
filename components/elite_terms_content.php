<?php
/**
 * BM FOREX HUB — Authoritative Elite Circle Terms and Conditions Content (v1.0)
 * Effective Date: 05 January 2026
 * Operating Entity: Varban Company Limited
 * Associated Parent: Stillrock Ventures
 * Jurisdiction: Republic of Kenya
 *
 * This component is the single authoritative source for the Elite Circle Terms content.
 * Reused across terms-elite.php, bm_elites.php, and elite_enrollment.php.
 */
?>
<div class="elite-terms-document-inner">
  
  <div class="legal-header-box">
    <div class="badge-pill">👑 BM ELITES TRADING CIRCLE</div>
    <h1>Elite Circle Terms and Conditions</h1>
    <p class="legal-header-desc">
