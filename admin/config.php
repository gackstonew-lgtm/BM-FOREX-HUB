...
function sqlite_admin_get($table, $params = []) {
  try {
    $pdo = getMarketPDO();
    $allowed = ['subscriptions', 'user_subscriptions', 'payments', 'profiles', 'admin_audit_logs', 'market_overview_announcements', 'market_announcements', 'educational_articles', 'featured_videos', 'promotions', 'copy_traders', 'copy_trader_audit_logs', 'elite_circle_enrollments'];
