 ...
 * BM Forex Hub — Public User Registration API
 */
...
if (!$createResp || $httpCode >= 400) {
    ...
    send_json(['success' => false, 'error' => 'Failed to create account. Please try again.'], 500);
}
...
if (!$userId) {
    send_json(['success' => false, 'error' => 'Account creation failed. Please try again.'], 500);
}
